            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="income" class="col-md-4 col-form-label text-md-right">{{ __('messages.income') }}</label>
                        ...
                        <div class="form-group row">
                            <label class="col-md-4 text-md-right">公開/非公開</label>
                            <div class="col-md-6 can-toggle">
